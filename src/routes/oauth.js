...
const PROVIDERS = {
  meta: {
    ...
    scope: 'instagram_business_basic,instagram_business_manage_comments,instagram_business_manage_messages,instagram_content_publish,pages_show_list,ads_management,ads_read',
  },
  google: {
